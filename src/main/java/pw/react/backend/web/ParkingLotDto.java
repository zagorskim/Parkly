...
public record ParkingLotDto(Long id, String description, String name, String photo, String pricePerDay, double latitude, double longitude, boolean security, String parkingLotType) {
